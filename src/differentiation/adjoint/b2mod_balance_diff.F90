...
!
  SUBROUTINE WRITE_BALANCE(ncv, nfc, nvx, nsd, geo, mpg)
    USE B2US_GEO_DIFF
    USE B2US_MAP_DIFF
    USE B2MOD_USER_NAMELIST_DIFF, ONLY : nimp, imp, nomp, omp
    USE B2MOD_B2CMPA_DIFF, ONLY : zamin, zamax
...
!   ..za:
    vdims(1) = nsid
    ALLOCATE(za(0:nsd-1))
    za(0:nsd-1) = NINT((zamin(0:nsd-1)+zamax(0:nsd-1))/2.0_R8)
