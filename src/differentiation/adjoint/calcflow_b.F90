...
!   ..local variables
  ...
  EXTERNAL UPWIND, HYBR, hybr_fwd, upwind_fwd
!
!   ..procedures
  REAL(kind=r8) :: HYBR, UPWIND, hybr_fwd, upwind_fwd
  INTRINSIC ABS
  EXTERNAL XERRAB
  REAL(kind=r8) :: abs0
  REAL(kind=r8) :: abs1
...
!
  ...
  EXTERNAL UPWIND_FWD, UPWIND_BWD, HYBR_FWD, HYBR_BWD
  REAL(kind=r8) :: HYBR, UPWIND
  REAL(kind=r8) :: HYBR_FWD, UPWIND_FWD
  INTRINSIC ABS
  EXTERNAL XERRAB
  REAL(kind=r8) :: abs0
  REAL(kind=r8) :: abs0b
