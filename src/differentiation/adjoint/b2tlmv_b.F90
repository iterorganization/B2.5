...
!   gradient     of useful results: vsbfx nb cvsbxhz ub cvsbx tb
...
!
!srv 09.01.01
SUBROUTINE B2TLMV_B(ncv, nfc, nvx, isb, cflmv, switch, geo, geob, mpg, &
& mpgb, nb, nbb, tb, tbb, ub, ubb, vsbfx, vsbfxb, cvsbx, cvsbxb, cvsbxhz&
& , cvsbxhzb, fl)
  USE B2MOD_TYPES
...
!srv 12.04.04
  ...
  REAL(kind=r8) :: qclb, qflb, tflb, ubvb(nvx), dubb(nfc)
  INTRINSIC ABS
  EXTERNAL XERTST
