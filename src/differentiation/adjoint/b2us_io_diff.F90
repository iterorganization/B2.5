...
& , read_b2fplasma, write_b2fplasma
  PUBLIC :: read_b2fgmtry_b, read_b2fstate_b

CONTAINS
!  Differentiation of read_b2fgmtry as a context to call adjoint code (with options context noISIZE r8):
...
!**********************************************************************
!
  SUBROUTINE READ_B2FGMTRY_B(ninp, mpg, mpgb, gm, gmb)
    IMPLICIT NONE
...
!
    CALL READ_MAPPING_B(ninp, mpg, mpgb)
    CALL READ_GEOMETRY_B(ninp, mpg%ncv, mpg%nfc, mpg%nvx, mpg%nfs, mpg%&
&                  nft, mpg%nvmxcv, gm, gmb)
  END SUBROUTINE READ_B2FGMTRY_B
...
!  Differentiation of read_b2fstate as a context to call adjoint code (with options context noISIZE r8):
...
!**********************************************************************
!
  SUBROUTINE READ_B2FSTATE_B(ninp, ncv, nfc, ns, nsb, st, stb)
    IMPLICIT NONE
...
! ..read the state
!
    CALL READ_STATE_B(ninp, ncv, nfc, ns, nsb, st, stb)
  END SUBROUTINE READ_B2FSTATE_B
