...
!
  ...
  REAL(kind=r8), SAVE :: dtcob(0:nsdmax-1, 0:cvregmax),dtcob0(0:nsdmax-1, 0:cvregmax)
  REAL(kind=r8), SAVE :: dtmo(0:nsdmax-1, 0:cvregmax)
  REAL(kind=r8), SAVE :: dtmob(0:nsdmax-1, 0:cvregmax),dtmob0(0:nsdmax-1, 0:cvregmax)
  REAL(kind=r8), SAVE :: dtee(0:cvregmax)
  REAL(kind=r8), SAVE :: dteeb(0:cvregmax),dteeb0(0:cvregmax)
  REAL(kind=r8), SAVE :: dtei(0:cvregmax)
  REAL(kind=r8), SAVE :: dteib(0:cvregmax),dteib0(0:cvregmax)
  REAL(kind=r8), SAVE :: dten(0:cvregmax)
  REAL(kind=r8), SAVE :: dtenb(0:cvregmax),dtenb0(0:cvregmax)
! IYS 19.12.2017
  REAL(kind=r8), SAVE :: corr_core_dn(0:nsdmax-1)
  REAL(kind=r8), SAVE :: corr_core_dnb(0:nsdmax-1),corr_core_dnb0(0:nsdmax-1)
...
! IYS 19.12.2017
  ...
  REAL(kind=r8), SAVE :: corr_core_dtb, corr_core_dtb0
  REAL(kind=r8), SAVE :: time_factor_required, core_dt_suppression, &
& core_dt_factor
  REAL(kind=r8), SAVE :: time_factor_requiredb,time_factor_requiredb0, core_dt_suppressionb,core_dt_suppressionb0, &
...
END MODULE B2MOD_NUMERICS_NAMELIST_DIFF
