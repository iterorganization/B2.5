...
!WG_TODO      use b2mod_b2_to_astra
!WG_TODO      use b2mod_astra_to_b2
  USE B2US_GEO_DIFF
  USE B2US_MAP_DIFF
...
!
!
  SUBROUTINE B2MN_INIT_B(switch, geo, geob, mpg, mpgb, state, stateb, &
...
!   ..call principal driver routine
    CALL ALLOC_B2MOD_PPOUT(1, 1, ns)
    CALL ALLOC_B2MOD_RECYCLE(mpg%nfc, ns)
!nh 30.03.21
!WG_TODO      call alloc_b2mod_astra_to_b2(nx, ny)
!WG_TODO      call alloc_b2mod_b2_to_astra(nx, ny, ns)
!
    CALL B2MNDR_0_B(ninp, nout, ns, nsb, ns0, switch, geo, geob, mpg, &
...
!
!
  SUBROUTINE B2MN_INIT(switch, geo, mpg, state, state_ext)
    IMPLICIT NONE
    TYPE(SWITCHES), INTENT(INOUT) :: switch
    TYPE(MAPPING), INTENT(INOUT) :: mpg
    TYPE(GEOMETRY), INTENT(INOUT) :: geo
...
&   stateb, state_ext, state_extb, j)
    ...
    USE B2MOD_NEUTRALS_NAMELIST_DIFF
    USE B2MOD_USER_NAMELIST_DIFF, ONLY : sigma, sigmab, nsigma
...
&             state, stateb, state_ext, state_extb, j, jb)
      ...
      write(*,*) 'GRADIENT vsa ',parm_vsab(1)
      write(*,*) 'GRADIENT sig ',parm_sigb
      write(*,*) 'GRADIENT alf ',parm_alfb
      write(*,*) 'GRADIENT conpar 1',conparb(0,1,1)
      write(*,*) 'GRADIENT conpar 2',conparb(0,2,1)
      write(*,*) 'GRADIENT conpar 3',conparb(0,3,1)
      write(*,*) 'GRADIENT conpar 4',conparb(0,4,1)
      write(*,*) 'GRADIENT conpar 5',conparb(0,5,1)
      write(*,*) 'GRADIENT conpar 6',conparb(0,6,1)
      write(*,*) 'GRADIENT conpar 1',conparb(1,1,1)
      write(*,*) 'GRADIENT conpar 2',conparb(1,2,1)
      write(*,*) 'GRADIENT conpar 3',conparb(1,3,1)
      write(*,*) 'GRADIENT conpar 4',conparb(1,4,1)
      write(*,*) 'GRADIENT conpar 5',conparb(1,5,1)
      write(*,*) 'GRADIENT conpar 6',conparb(1,6,1)
      write(*,*) 'GRADIENT mompar 1',momparb(0,1,1)
      write(*,*) 'GRADIENT mompar 2',momparb(0,2,1)
      write(*,*) 'GRADIENT mompar 3',momparb(0,3,1)
      write(*,*) 'GRADIENT mompar 4',momparb(0,4,1)
      write(*,*) 'GRADIENT mompar 5',momparb(0,5,1)
      write(*,*) 'GRADIENT mompar 6',momparb(0,6,1)
      write(*,*) 'GRADIENT mompar 1',momparb(1,1,1)
      write(*,*) 'GRADIENT mompar 2',momparb(1,2,1)
      write(*,*) 'GRADIENT mompar 3',momparb(1,3,1)
      write(*,*) 'GRADIENT mompar 4',momparb(1,4,1)
      write(*,*) 'GRADIENT mompar 5',momparb(1,5,1)
      write(*,*) 'GRADIENT mompar 6',momparb(1,6,1)
      write(*,*) 'GRADIENT enepar 1',eneparb(1,1)
      write(*,*) 'GRADIENT enepar 2',eneparb(2,2)
      write(*,*) 'GRADIENT enepar 3',eneparb(3,2)
      write(*,*) 'GRADIENT enepar 4',eneparb(4,1)
      write(*,*) 'GRADIENT enepar 5',eneparb(5,1)
      write(*,*) 'GRADIENT enepar 6',eneparb(6,1)
      write(*,*) 'GRADIENT enipar 1',eniparb(1,1)
      write(*,*) 'GRADIENT enipar 2',eniparb(2,1)
      write(*,*) 'GRADIENT enipar 3',eniparb(3,1)
      write(*,*) 'GRADIENT enipar 4',eniparb(4,1)
      write(*,*) 'GRADIENT enipar 5',eniparb(5,1)
      write(*,*) 'GRADIENT enipar 6',eniparb(6,1)
      write(*,*) 'GRADIENT potpar 1',potparb(1,1)
      write(*,*) 'GRADIENT potpar 2',potparb(2,2)
      write(*,*) 'GRADIENT potpar 3',potparb(3,2)
      write(*,*) 'GRADIENT potpar 4',potparb(4,1)
      write(*,*) 'GRADIENT potpar 5',potparb(5,1)
      write(*,*) 'GRADIENT potpar 6',potparb(6,1)
      write(*,*) 'GRADIENT recyc 1',b2recycb(0,1)
      write(*,*) 'GRADIENT recyc 2',b2recycb(0,2)
      write(*,*) 'GRADIENT recyc 3',b2recycb(0,3)
      write(*,*) 'GRADIENT recyc 4',b2recycb(0,4)
      write(*,*) 'GRADIENT recyc 5',b2recycb(0,5)
      write(*,*) 'GRADIENT recyc 1',b2recycb(1,1)
      write(*,*) 'GRADIENT recyc 2',b2recycb(1,2)
      write(*,*) 'GRADIENT recyc 3',b2recycb(1,3)
      write(*,*) 'GRADIENT recyc 4',b2recycb(1,4)
      write(*,*) 'GRADIENT recyc 5',b2recycb(1,5)
      write(*,*) 'GRADIENT rtlsa',rtlsab(135,240,0)
      write(*,*) 'GRADIENT rtlra',rtlrab(135,240,1)
      write(*,*) 'GRADIENT rtlcx',rtlcxb(135,240,1)
      write(*,*) 'GRADIENT rtlqa',rtlqab(135,240,0)
      write(*,*) 'GRADIENT rtlqa',rtlqab(135,240,1)
      write(*,*) 'GRADIENT tdata 1',tdatab(2,2,1,1)
      write(*,*) 'GRADIENT tdata 2',tdatab(2,4,1,1)
      write(*,*) 'GRADIENT tdata 3',tdatab(2,1,3,1)
      write(*,*) 'GRADIENT tdata 4',tdatab(2,6,3,1)
      write(*,*) 'GRADIENT tdata 5',tdatab(2,3,4,1)
      write(*,*) 'GRADIENT tdata 6',tdatab(2,5,4,1)
      write(*,*) 'GRADIENT ballooning',switchb%b2tqna_ballooning
      write(*,*) 'GRADIENT ballooning_resc',switchb%b2tqna_ballooning_rescale

      write(*,*) 'GRADIENT enkpar 1',enkparb(1,1)
      write(*,*) 'GRADIENT keps_cd',switchb%keps_cd
      write(*,*) 'GRADIENT keps_heat',switchb%keps_heat
      write(*,*) 'GRADIENT keps_heat_i',switchb%keps_heat_i
      write(*,*) 'GRADIENT b2sikt_fac_sheath',switchb%b2sikt_fac_sheath
      write(*,*) 'GRADIENT b2sikt_fac_sheath_core',switchb%b2sikt_fac_sheath_core
      write(*,*) 'GRADIENT b2sikt_fac_diss',switchb%b2sikt_fac_diss
      write(*,*) 'GRADIENT b2sikt_fac_diss_core',switchb%b2sikt_fac_diss_core
      write(*,*) 'GRADIENT b2tfhi_fsigkt',switchb%b2tfhi_fsigkt

      write(*,*) 'GRADIENT dna ',parm_dnab(3)
      write(*,*) 'GRADIENT hci ',parm_hcib(4)
      write(*,*) 'GRADIENT conpar 1',conparb(1,1,1)
      write(*,*) 'GRADIENT conpar 1',conparb(4,1,1)
      do ii=1,nsigma
        write(*,*) 'GRADIENT sigma',sigmab(ii)
      end do
...
!
  SUBROUTINE B2MN_STEP(switch, geo, mpg, state, state_ext, j)
    USE B2MOD_TYPES
    USE B2MOD_B2CMPT_DIFF
    USE B2MOD_B2CMRC_DIFF
    USE B2MOD_BOUNDARY_NAMELIST_DIFF
    USE B2MOD_NEUTRALS_NAMELIST_DIFF
    USE B2MOD_USER_NAMELIST_DIFF, ONLY : sigma, nsigma
    USE B2MOD_INPUT_PROFILE_DIFF, ONLY : tdata
    USE B2MOD_AD_DIFF, ONLY : nncf
    USE B2MOD_PAR_OPT_DIFF, ONLY : par_opt_phys, npar_opt
    IMPLICIT NONE
    TYPE(SWITCHES), INTENT(INOUT) :: switch
    TYPE(MAPPING), INTENT(INOUT) :: mpg
    TYPE(GEOMETRY), INTENT(INOUT) :: geo
...
!
    call set_parameters(switch)
    CALL B2MNDR_1(nout, ns, switch, geo, mpg, state, state_ext, j)
!
    RETURN
...
&   state_ext, state_extb)
    ...
    INTRINSIC SIZE
!
    CALL B2MNDR_2_B(nout, ns, switch, geo, geob, mpg, mpgb, state, &
...
!
  SUBROUTINE B2MN_FIN(switch, geo, mpg, state, state_ext)
    IMPLICIT NONE
    TYPE(SWITCHES), INTENT(INOUT) :: switch
    TYPE(MAPPING), INTENT(INOUT) :: mpg
    TYPE(GEOMETRY), INTENT(INOUT) :: geo
