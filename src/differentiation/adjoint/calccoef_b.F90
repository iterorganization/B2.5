...
!-----------------------------------------------------------------------
!.specification
SUBROUTINE CALCCOEF_FWD(ncv, nfc, nvx, meth, geo, mpg, flo, con, flo0, &
& con0)
  USE B2MOD_TYPES
  USE B2US_GEO_DIFF
  USE B2US_MAP_DIFF
...
!   ..local variables
  ...
  EXTERNAL HYBR, hybr_fwd
!
!   ..procedures
  REAL(kind=r8) :: HYBR, hybr_fwd
  INTRINSIC ABS
  EXTERNAL XERRAB
  REAL(kind=r8) :: abs0
  REAL(kind=r8) :: abs1
...
!-----------------------------------------------------------------------
!.specification
SUBROUTINE CALCCOEF_BWD(ncv, nfc, nvx, meth, geo, mpg, flo, flob, con, &
& conb, flo0, flo0b, con0, con0b)
  USE B2MOD_TYPES
  USE B2US_GEO_DIFF
  USE B2US_MAP_DIFF
  IMPLICIT NONE
