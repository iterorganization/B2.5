...
!
!  Differentiation of diff_r in reverse (adjoint) mode, forward sweep (with options context noISIZE r8):
!   gradient     of useful results: dfunr funv fun
...
!-----------------------------------------------------------------------
!.specification
SUBROUTINE DIFF_R_FWD(ncv, nfc, nvx, mode, geo, mpg, mpgb, fun, funv, &
& dfunr)
  USE B2MOD_TYPES
  USE B2US_GEO_DIFF
  USE B2US_MAP_DIFF
...
&     )
  END DO
END SUBROUTINE DIFF_R_FWD

!  Differentiation of diff_r in reverse (adjoint) mode, backward sweep (with options context noISIZE r8):
!   gradient     of useful results: dfunr funv fun
!   with respect to varying inputs: dfunr funv fun
!
!
...
!-----------------------------------------------------------------------
!.specification
SUBROUTINE DIFF_R_BWD(ncv, nfc, nvx, mode, geo, mpg, mpgb, fun, funb, &
& funv, funvb, dfunr, dfunrb)
  USE B2MOD_TYPES
  USE B2US_GEO_DIFF
  USE B2US_MAP_DIFF
  IMPLICIT NONE
