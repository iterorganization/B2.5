...
!srv 09.01.01
!srv 07.07.09
SUBROUTINE B2STCX_B(ncv, nfc, ns, is0, ismain, switch, geo, geob, mpg, &
& na, nab, ua, uab, ti, tib, tn, tnb, ni, rcx, rcxb, sna0, sna0b, smq0, &
& smq0b, shi0, shi0b, shn0, shn0b)
  USE B2MOD_TYPES
  USE B2MOD_CONSTANTS
!      use b2mod_tallies
!      use b2mod_sources
...
&           (icv, 1, is0) + (ua(icv, is0)+rg0*ua(icv, is0+1))*smq0b(icv&
&           , 0, is0+1) - rg0*smq0b(icv, 1, is0+1)
          uab(icv, is0) = uab(icv, is0) + t2*rg0*smq0b(icv, 0, is0) + t2&
&           *smq0b(icv, 0, is0+1)
          uab(icv, is0+1) = uab(icv, is0+1) + rg0*t2*smq0b(icv, 0, is0+1&
&           )
...
&                 temp1*tempb0
            ...
            ELSE
              ...
              tempb1 = ((am(is)+am(is-1))*(du0**2/2.0_R8)+(am(is0)+am(&
&               is0+1))*(du1**2/2.0_R8))*tempb2
        ...
        ELSE
          ...
          tempb0 = ((am(is)+am(is-1))*(du0**2/2.0_R8)+(am(is0)+am(is0+1)&
&           )*(du1**2/2.0_R8))*tempb
