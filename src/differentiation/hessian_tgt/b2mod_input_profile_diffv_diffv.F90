...
&                           ndim)
                    ...
                    ELSE
                      DO nd=1,nbdirs
                        DO nd0=nd,nbdirs0
                          profdd(nd0, nd, 1:ndim) = pfdd(nd0, nd, 1:ndim&
&                           )
                        END DO
...
&                         is)) + rt%rza(icv, nsp(is))*pld0%te(nd0, icv) &
&                         + pld0%ti(nd0, icv)
                        temp0d(nd0) = (profd0(nd0, iy2)-temp1*tempd(nd0)&
&                         )/temp
                      END DO
                      temp0 = temp1
                      DO nd=1,nbdirs
...
&                           poloidal_scale_factor*(profdd(nd0, nd, iy2)-&
&                           temp3*temp0d(nd0)-temp0*(temp2*pld0%te(nd0, &
&                           icv)+pl%te(icv)*rtdd%rza(nd0, nd, icv, nsp(&
&                           is))+pld%te(nd, icv)*rtd0%rza(nd0, icv, nsp(&
&                           is))+rt%rza(icv, nsp(is))*pldd%te(nd0, nd, &
&                           icv)+pldd%ti(nd0, nd, icv))-temp1*tempd(nd0)&
&                           )/temp
                        END DO
...
&                           profdd(nd0, nd, iy2)+temp3*profd0(nd0, iy2)+&
&                           prof(iy2)*pldd%na(nd0, nd, icv, nsp(is)))
                        END DO
...
&                           profd(nd, iy2)*dvd0%ne(nd0, icv)+dv%ne(icv)*&
&                           profdd(nd0, nd, iy2)+dvd%ne(nd, icv)*profd0(&
&                           nd0, iy2)+prof(iy2)*dvdd%ne(nd0, nd, icv))
                        END DO
                        hce0d(nd, icv) = poloidal_scale_factor*(dv%ne(&
&                         icv)*profd(nd, iy2)+prof(iy2)*dvd%ne(nd, icv))
                      END DO
                      DO nd0=1,nbdirs0
                        hce0d0(nd0, icv) = poloidal_scale_factor*(dv%ne(&
&                         icv)*profd0(nd0, iy2)+prof(iy2)*dvd0%ne(nd0, &
&                         icv))
                      END DO
...
&                         is))*profd(nd, iy2)+prof(iy2)*temp3)
                      END DO
                      DO nd0=1,nbdirs0
...
&                             poloidal_scale_factor*(profd(nd, iy2)*dvd0&
&                             %ne(nd0, icv)+dv%ne(icv)*profdd(nd0, nd, &
&                             iy2)+dvd%ne(nd, icv)*profd0(nd0, iy2)+prof&
&                             (iy2)*dvdd%ne(nd0, nd, icv))
                          END DO
...
&                           dv%ne(icv)*profd0(nd0, iy2)+prof(iy2)*dvd0%&
&                           ne(nd0, icv))
                        END DO
...
&                     THEN
                        DO nd=1,nbdirs
                          DO nd0=nd,nbdirs0
                            sig0dd(nd0, nd, icv) = qe*&
&                             poloidal_scale_factor*(profd(nd, iy2)*dvd0&
&                             %ne(nd0, omp(1))+dv%ne(omp(1))*profdd(nd0&
&                             , nd, iy2)+dvd%ne(nd, omp(1))*profd0(nd0, &
&                             iy2)+prof(iy2)*dvdd%ne(nd0, nd, omp(1)))
                          END DO
                          sig0d(nd, icv) = qe*poloidal_scale_factor*(dv%&
...
&                         icv))
                      ...
                      DO nd=1,nbdirs
                        ...
                        DO nd0=1,nbdirs0
                          arg1dd(nd0, nd) = -(temp1*pldd%te(nd0, nd, icv&
&                           )+pld%te(nd, icv)*(temp0d(nd0)-temp1*pld0%te&
&                           (nd0, icv))/pl%te(icv))
                        END DO
                      ...
                      DO nd=1,nbdirs
                        ...
                        ELSE
                          ...
                          DO nd0=1,nbdirs0
                            result1dd(nd0, nd) = (arg1dd(nd0, nd)-temp1*&
&                             2.0*temp0d(nd0))/(2.0*temp0)
                          END DO
                          result1d(nd) = temp1
                        END IF
...
&                           temp1*dvd0%ne(nd0, icv)+dv%ne(icv)*(profd(nd&
&                           , iy2)*result1d0(nd0)+result1*profdd(nd0, nd&
&                           , iy2)+result1d(nd)*profd0(nd0, iy2)+prof(&
&                           iy2)*result1dd(nd0, nd))+dvd%ne(nd, icv)*(&
&                           result1*profd0(nd0, iy2)+prof(iy2)*result1d0&
&                           (nd0))+prof(iy2)*result1*dvdd%ne(nd0, nd, &
&                           icv))
                        END DO
...
&                         icv)*temp1+prof(iy2)*result1*dvd%ne(nd, icv))
                      END DO
                      DO nd0=1,nbdirs0
                        alf0d0(nd0, icv) = poloidal_scale_factor*(dv%ne(&
&                         icv)*(result1*profd0(nd0, iy2)+prof(iy2)*&
&                         result1d0(nd0))+prof(iy2)*result1*dvd0%ne(nd0&
&                         , icv))
                      END DO
...
!
                  IF (elm_region) THEN
                    DO nd=1,nbdirs
                      DO nd0=nd,nbdirs0
                        profdd(nd0, nd, 1:ndim) = pelmdd(nd0, nd, 1:ndim&
&                         )
                      END DO
                      profd(nd, 1:ndim) = pelmd(nd, 1:ndim)
                    END DO
...
&                       profd(nd, iy2)
                    END DO
                    DO nd0=1,nbdirs0
                      dna0d0(nd0, icv, nsp(is)) = poloidal_scale_factor*&
&                       profd0(nd0, iy2)
                    END DO
...
!
                  ELSE IF (kind_coeff .EQ. 2) THEN
                    ...
                    temp1 = prof(iy2)/temp
                    DO nd0=1,nbdirs0
                      tempd(nd0) = pl%te(icv)*rtd0%rza(nd0, icv, nsp(is)&
&                       ) + rt%rza(icv, nsp(is))*pld0%te(nd0, icv) + &
&                       pld0%ti(nd0, icv)
                      temp0d(nd0) = (profd0(nd0, iy2)-temp1*tempd(nd0))/&
&                       temp
                    END DO
...
&                       pld%te(nd, icv) + pld%ti(nd, icv)
                      ...
                      DO nd0=1,nbdirs0
                        dpa0dd(nd0, nd, icv, nsp(is)) = &
&                         poloidal_scale_factor*(profdd(nd0, nd, iy2)-&
&                         temp2*temp0d(nd0)-temp0*(temp3*pld0%te(nd0, &
&                         icv)+pl%te(icv)*rtdd%rza(nd0, nd, icv, nsp(is)&
&                         )+pld%te(nd, icv)*rtd0%rza(nd0, icv, nsp(is))+&
&                         rt%rza(icv, nsp(is))*pldd%te(nd0, nd, icv)+&
&                         pldd%ti(nd0, nd, icv))-temp1*tempd(nd0))/temp
                      END DO
                      dpa0d(nd, icv, nsp(is)) = poloidal_scale_factor*&
&                       temp1
                    END DO
                    DO nd0=1,nbdirs0
                      dpa0d0(nd0, icv, nsp(is)) = poloidal_scale_factor*&
&                       temp0d(nd0)
                    END DO
                    dpa0(icv, nsp(is)) = poloidal_scale_factor*temp0
!
                  ELSE IF (kind_coeff .EQ. 3) THEN
                    DO nd=1,nbdirs
                      ...
                      DO nd0=1,nbdirs0
                        hcibdd(nd0, nd, icv, nsp(is)) = &
&                         poloidal_scale_factor*(profd(nd, iy2)*pld0%na(&
&                         nd0, icv, nsp(is))+pl%na(icv, nsp(is))*profdd(&
&                         nd0, nd, iy2)+temp3*profd0(nd0, iy2)+prof(iy2)&
&                         *pldd%na(nd0, nd, icv, nsp(is)))
                      END DO
                      hcibd(nd, icv, nsp(is)) = poloidal_scale_factor*(&
&                       pl%na(icv, nsp(is))*profd(nd, iy2)+prof(iy2)*&
&                       temp3)
                    END DO
                    DO nd0=1,nbdirs0
                      hcibd0(nd0, icv, nsp(is)) = poloidal_scale_factor*&
&                       (pl%na(icv, nsp(is))*profd0(nd0, iy2)+prof(iy2)*&
&                       pld0%na(nd0, icv, nsp(is)))
                    END DO
...
&                       *profd(nd, iy2)+prof(iy2)*dvd%ne(nd, icv))
                    ...
                    DO nd0=1,nbdirs0
                      hce0d0(nd0, icv) = poloidal_scale_factor*(dv%ne(&
&                       icv)*profd0(nd0, iy2)+prof(iy2)*dvd0%ne(nd0, icv&
&                       ))
                    END DO
                    hce0(icv) = prof(iy2)*dv%ne(icv)*&
&                     poloidal_scale_factor
...
!
                  ELSE IF (kind_coeff .EQ. 7) THEN
                    ...
                    DO nd=1,nbdirs
                      temp3 = pld%na(nd, icv, nsp(is))
                      DO nd0=1,nbdirs0
                        vsa0dd(nd0, nd, icv, nsp(is)) = temp0*(profd(nd&
&                         , iy2)*pld0%na(nd0, icv, nsp(is))+pl%na(icv, &
&                         nsp(is))*profdd(nd0, nd, iy2)+temp3*profd0(nd0&
&                         , iy2)+prof(iy2)*pldd%na(nd0, nd, icv, nsp(is)&
&                         ))
                      END DO
...
&                       ))*profd(nd, iy2)+prof(iy2)*temp3)
                    END DO
                    DO nd0=1,nbdirs0
                      vsa0d0(nd0, icv, nsp(is)) = temp0*(pl%na(icv, nsp(&
&                       is))*profd0(nd0, iy2)+prof(iy2)*pld0%na(nd0, icv&
&                       , nsp(is)))
                    END DO
                    ...
                    IF (csig_an_style .EQ. 0) THEN
                      DO nd=1,nbdirs
                        DO nd0=nd,nbdirs0
                          sig0dd(nd0, nd, icv) = qe*&
&                           poloidal_scale_factor*(profd(nd, iy2)*dvd0%&
&                           ne(nd0, icv)+dv%ne(icv)*profdd(nd0, nd, iy2)&
&                           +dvd%ne(nd, icv)*profd0(nd0, iy2)+prof(iy2)*&
&                           dvdd%ne(nd0, nd, icv))
                        END DO
...
&                         )
                      END DO
                      DO nd0=1,nbdirs0
                        sig0d0(nd0, icv) = qe*poloidal_scale_factor*(dv%&
&                         ne(icv)*profd0(nd0, iy2)+prof(iy2)*dvd0%ne(nd0&
&                         , icv))
                      END DO
                      sig0(icv) = prof(iy2)*qe*dv%ne(icv)*&
&                       poloidal_scale_factor
...
&                   THEN
                      DO nd=1,nbdirs
                        DO nd0=nd,nbdirs0
                          sig0dd(nd0, nd, icv) = qe*&
&                           poloidal_scale_factor*(profd(nd, iy2)*dvd0%&
&                           ne(nd0, omp(1))+dv%ne(omp(1))*profdd(nd0, nd&
&                           , iy2)+dvd%ne(nd, omp(1))*profd0(nd0, iy2)+&
&                           prof(iy2)*dvdd%ne(nd0, nd, omp(1)))
                        END DO
                        sig0d(nd, icv) = qe*poloidal_scale_factor*(dv%ne&
...
&                         omp(1)))
                      ...
                      DO nd0=1,nbdirs0
                        sig0d0(nd0, icv) = qe*poloidal_scale_factor*(dv%&
&                         ne(omp(1))*profd0(nd0, iy2)+prof(iy2)*dvd0%ne(&
&                         nd0, omp(1)))
                      END DO
                      sig0(icv) = prof(iy2)*qe*dv%ne(omp(1))*&
&                       poloidal_scale_factor
...
!
                    temp1 = qe/pl%te(icv)
                    DO nd0=1,nbdirs0
                      temp0d(nd0) = -(temp1*pld0%te(nd0, icv)/pl%te(icv)&
&                       )
                    END DO
                    temp0 = temp1
                    DO nd=1,nbdirs
                      ...
                      DO nd0=1,nbdirs0
                        arg1dd(nd0, nd) = -(temp1*pldd%te(nd0, nd, icv)+&
&                         pld%te(nd, icv)*(temp0d(nd0)-temp1*pld0%te(nd0&
&                         , icv))/pl%te(icv))
                      END DO
                      arg1d(nd) = -(pld%te(nd, icv)*temp1)
                    END DO
...
&                         temp1*dvd0%ne(nd0, icv)+dv%ne(icv)*(profd(nd, &
&                         iy2)*result1d0(nd0)+result1*profdd(nd0, nd, &
&                         iy2)+result1d(nd)*profd0(nd0, iy2)+prof(iy2)*&
&                         result1dd(nd0, nd))+dvd%ne(nd, icv)*(result1*&
&                         profd0(nd0, iy2)+prof(iy2)*result1d0(nd0))+&
&                         prof(iy2)*result1*dvdd%ne(nd0, nd, icv))
                      END DO
                      alf0d(nd, icv) = poloidal_scale_factor*(dv%ne(icv)&
&                       *temp1+prof(iy2)*result1*dvd%ne(nd, icv))
                    END DO
                    DO nd0=1,nbdirs0
                      alf0d0(nd0, icv) = poloidal_scale_factor*(dv%ne(&
&                       icv)*(result1*profd0(nd0, iy2)+prof(iy2)*&
