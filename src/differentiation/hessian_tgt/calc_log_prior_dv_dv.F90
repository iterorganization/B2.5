...
!
!  Differentiation of calc_log_prior_dv in forward (tangent) mode (with options multiDirectional context noISIZE r8):
!   variations   of useful results: priord
...
!
!
SUBROUTINE CALC_LOG_PRIOR_DV_DV(prior, priord, priordd, inrange, nbdirs&
& , nbdirs0)
  USE B2MOD_TYPES
...
!Uninformative, proper, Gaussian prior.
      arg1 = 2.0_R8*pi
      DO nd=1,nbdirs
        temp0 = 2*par_opt_physd(nd, ii)*0.5_R8
        DO nd0=1,nbdirs0
          priordd(nd0, nd) = priordd(nd0, nd) - temp0*par_opt_physd0(nd0&
&           , ii)/prior_par(ii, 2)**2
        END DO
        priord(nd) = priord(nd) - temp0*((par_opt_phys(ii)-prior_par(ii&
&         , 1))/(prior_par(ii, 2)*prior_par(ii, 2)))
      END DO
...
! --> aa = (mu/sigma)**2; bb = mu/sigma**2
      ...
      DO nd0=1,nbdirs0
        arg10d0(nd0) = par_opt_physd0(nd0, ii)
      END DO
      ...
      DO nd=1,nbdirs
        ...
        temp0 = (aa-1)/arg10
        DO nd0=1,nbdirs0
          priordd(nd0, nd) = priordd(nd0, nd) - arg10d(nd)*temp0*arg10d0&
&           (nd0)/arg10
        END DO
        priord(nd) = priord(nd) - bb*par_opt_physd(nd, ii) + temp0*&
&         arg10d(nd)
      END DO
...
!Uninformative, proper, Gaussian prior.
        ...
        DO nd=1,nbdirs
          temp0 = 2*sigmad(nd, ii)*0.5_R8
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - temp0*sigmad0(nd0, ii)&
&             /temp
          END DO
          priord(nd) = priord(nd) - temp0*((sigma(ii)-prior_par(ind+&
&           isigma, 1))/temp)
        END DO
...
! gamma distribution x**(alpha-1)*exp(-beta*xx)*beta**alpha/Gamma(alpha)
        ...
        DO nd=1,nbdirs
          temp0 = (aa-1)/sigma(ii)
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - sigmad(nd, ii)*temp0*&
&             sigmad0(nd0, ii)/sigma(ii)
          END DO
          priord(nd) = priord(nd) + sigmad(nd, ii)*(temp0-bb)
        END DO
...
!Jeffrey's 1/sigma
        DO nd=1,nbdirs
          temp0 = sigmad(nd, ii)/sigma(ii)
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) + temp0*sigmad0(nd0, ii)&
&             /sigma(ii)
          END DO
          priord(nd) = priord(nd) - temp0
        END DO
...
!Uninformative, proper, Gaussian prior.
        ...
        DO nd=1,nbdirs
          temp0 = 2*meand(nd, ii)*0.5_R8
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - temp0*meand0(nd0, ii)/&
&             temp
          END DO
          priord(nd) = priord(nd) - temp0*((mean(ii)-prior_par(ind+imean&
&           , 1))/temp)
        END DO
...
! gamma distribution x**(alpha-1)*exp(-beta*xx)*beta**alpha/Gamma(alpha)
        ...
        DO nd=1,nbdirs
          temp0 = (aa-1)/mean(ii)
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - meand(nd, ii)*temp0*&
&             meand0(nd0, ii)/mean(ii)
          END DO
          priord(nd) = priord(nd) + meand(nd, ii)*(temp0-bb)
        END DO
...
!Uninformative, proper, Gaussian prior.
        arg1 = 2.0_R8*pi
        DO nd=1,nbdirs
          temp0 = 2*shiftd(nd, ii)*0.5_R8
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - temp0*shiftd0(nd0, ii)&
&             /shift_prior_par(ind, 2)**2
          END DO
          priord(nd) = priord(nd) - temp0*((shift(ii)-shift_prior_par(&
&           ind, 1))/(shift_prior_par(ind, 2)*shift_prior_par(ind, 2)))
        END DO
...
! gamma distribution x**(alpha-1)*exp(-beta*xx)*beta**alpha/Gamma(alpha)
        ...
        DO nd=1,nbdirs
          temp0 = (aa-1)/shift(ii)
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - shiftd(nd, ii)*temp0*&
&             shiftd0(nd0, ii)/shift(ii)
          END DO
          priord(nd) = priord(nd) + shiftd(nd, ii)*(temp0-bb)
        END DO
...
!Uninformative, proper, Gaussian prior.
        arg1 = 2.0_R8*pi
        DO nd=1,nbdirs
          temp0 = 2*corr_lengthd(nd, ii)*0.5_R8
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - temp0*corr_lengthd0(&
&             nd0, ii)/corr_prior_par(ind, 2)**2
          END DO
          priord(nd) = priord(nd) - temp0*((corr_length(ii)-&
&           corr_prior_par(ind, 1))/(corr_prior_par(ind, 2)*&
&           corr_prior_par(ind, 2)))
        END DO
...
! gamma distribution x**(alpha-1)*exp(-beta*xx)*beta**alpha/Gamma(alpha)
        ...
        result1 = LOG_GAMMA(aa)
        DO nd=1,nbdirs
          temp0 = (aa-1)/corr_length(ii)
          DO nd0=1,nbdirs0
            priordd(nd0, nd) = priordd(nd0, nd) - corr_lengthd(nd, ii)*&
&             temp0*corr_lengthd0(nd0, ii)/corr_length(ii)
          END DO
          priord(nd) = priord(nd) + corr_lengthd(nd, ii)*(temp0-bb)
        END DO
...
!
  CALL SUBEND()
  RETURN
END SUBROUTINE CALC_LOG_PRIOR_DV_DV
...
!
!
SUBROUTINE CALC_LOG_PRIOR_DV_NODIFF(prior, priord, inrange, nbdirs)
  USE B2MOD_TYPES
  USE B2MOD_PAR_OPT_DIFFV_DIFFV
  USE B2MOD_CONSTANTS
  USE B2MOD_SUBSYS
...
!Uninformative, proper, Gaussian prior.
      arg1 = 2.0_R8*pi
      DO nd=1,nbdirs
        priord(nd) = priord(nd) - 0.5_R8*2*(par_opt_phys(ii)-prior_par(&
&         ii, 1))*par_opt_physd(nd, ii)/prior_par(ii, 2)**2
      END DO
      prior = prior - LOG(prior_par(ii, 2)) - 0.5_R8*LOG(arg1) - 0.5_R8*&
&       ((par_opt_phys(ii)-prior_par(ii, 1))/prior_par(ii, 2))**2
    CASE (2) 
...
!
  CALL SUBEND()
  RETURN
END SUBROUTINE CALC_LOG_PRIOR_DV_NODIFF
...
!
!
SUBROUTINE CALC_LOG_PRIOR_NODIFF_NODIFF(prior, inrange)
  USE B2MOD_TYPES
  USE B2MOD_PAR_OPT_DIFFV_DIFFV
  USE B2MOD_CONSTANTS
  USE B2MOD_SUBSYS
...
!
  CALL SUBEND()
  RETURN
END SUBROUTINE CALC_LOG_PRIOR_NODIFF_NODIFF
