...
!
!  Differentiation of b2rurc_dv as a context to call tangent code (with options multiDirectional context noISIZE r8):
...
!.specification
!
SUBROUTINE B2RURC_DV_DV(nget, version, nbdirs, nbdirs0)
  USE B2MOD_TYPES
...
!   ..read dimensions
  ...
  CALL ALLOC_B2MOD_B2CMRC_DV_DV(idum(0), idum(1), idum(2), nbdirs, &
&                         nbdirs0)
!   ..read species data
...
!.specification
!
SUBROUTINE B2RURC_DV_NODIFF(nget, version, nbdirs)
  USE B2MOD_TYPES
  USE B2MOD_MATH_DIFFV_DIFFV
  USE B2MOD_B2CMRC_DIFFV_DIFFV
  USE B2MOD_B2CMPA_DIFFV_DIFFV
...
!   ..read dimensions
  CALL CFRUIN(nget, 3, idum, 'rtnt,rtnn,rtns')
  CALL ALLOC_B2MOD_B2CMRC_DV(idum(0), idum(1), idum(2), nbdirs)
!   ..read species data
  IF (version .LT. '01.001.024') THEN
    ALLOCATE(rtza(0:idum(2)-1))
    ALLOCATE(rtza2(0:idum(2)-1))
...
!
  CALL SUBEND()
  RETURN
END SUBROUTINE B2RURC_DV_NODIFF

!  Differentiation of b2rurc_nodiff as a context to call tangent code (with options multiDirectional context noISIZE r8):
!
!
!
!
...
!.specification
!
SUBROUTINE B2RURC_NODIFF_DV(nget, version, nbdirs)
  USE B2MOD_TYPES
  USE B2MOD_MATH_DIFFV_DIFFV
  USE B2MOD_B2CMRC_DIFFV_DIFFV
  USE B2MOD_B2CMPA_DIFFV_DIFFV
...
!
  CALL SUBEND()
  RETURN
END SUBROUTINE B2RURC_NODIFF_DV
...
!.specification
!
SUBROUTINE B2RURC_NODIFF_NODIFF(nget, version)
  USE B2MOD_TYPES
  USE B2MOD_MATH_DIFFV_DIFFV
  USE B2MOD_B2CMRC_DIFFV_DIFFV
  USE B2MOD_B2CMPA_DIFFV_DIFFV
...
!
  CALL SUBEND()
  RETURN
END SUBROUTINE B2RURC_NODIFF_NODIFF
