...
!parameters for prior
  ...
  REAL(kind=r8), SAVE :: sigmad0(nbdirsmax0, nsigmx)=0.0_8
  ...
  REAL(kind=r8), SAVE :: meand0(nbdirsmax0, nsigmx)=0.0_8
  ...
  REAL(kind=r8), SAVE :: shiftd0(nbdirsmax0, nsigmx)=0.0_8
...
& nsigmx, 2)
  ...
  REAL(kind=r8), SAVE :: corr_lengthd0(nbdirsmax0, nncf)=0.0_8
...
!store here radial distance coordinate of SOLPS data
      ...
      b2datadd(:, 1:nbdirsmax, 1:numdata) = 0.0_8
...
!                b2dataoncfd:out b2datad:out b2dataoncf:out
