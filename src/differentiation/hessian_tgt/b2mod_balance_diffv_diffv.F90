...
!
!
MODULE B2MOD_BALANCE_DIFFV_DIFFV
  USE B2MOD_TYPES
...
!
  SUBROUTINE WRITE_BALANCE(ncv, nfc, nvx, nsd, geo, mpg)
    ...
    USE B2MOD_USER_NAMELIST_DIFFV_DIFFV, ONLY : nimp, imp, nomp, omp
    USE B2MOD_B2CMPA_DIFFV_DIFFV, ONLY : zamin, zamax
...
!   ..procedures
    INTRINSIC SIZE
    EXTERNAL IPGETI, GET_JSEP, IPGETR, SPECIES_NODIFF_NODIFF, &
&       CHECK_CDF_STATUS
    INTRINSIC ALLOCATED
    INTRINSIC NINT
...
!   ..species string:
    ...
    DO is=0,nsd-1
      CALL SPECIES_NODIFF_NODIFF(is, species_name(is), .false.)
    END DO
...
END MODULE B2MOD_BALANCE_DIFFV_DIFFV
