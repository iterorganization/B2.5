...
&     , nfsvxmx, nxpt, nstr, ntgc
  ...
  END TYPE MAPPING
  TYPE, PUBLIC :: MAPPING_DIFFV0
      INTEGER, DIMENSION(:, :, :), ALLOCATABLE :: rcfcp
  END TYPE MAPPING_DIFFV0
  TYPE, PUBLIC :: MAPPING_DIFFV
      ...
      INTEGER :: ncv(nbdirsmax), nfc(nbdirsmax), nvx(nbdirsmax), ncg(&
&     nbdirsmax), nci(nbdirsmax), ncmxvx(nbdirsmax), ncmxfc(nbdirsmax), &
&     nvmxcv(nbdirsmax), nvmxfc(nbdirsmax), nfs(nbdirsmax), nbc(&
&     nbdirsmax), mxnbc(nbdirsmax), nrc(nbdirsmax), mxnrc(nbdirsmax), &
...
!
    ...
    CALL CFWURE_NODIFF(nout, mpg%ncmxfc, mpg%intcellp, 'intcellP')
    CALL CFWURE_NODIFF(nout, mpg%ncmxfc, mpg%intcellr, 'intcellR')
!
...
END MODULE B2US_MAP_DIFFV_DIFFV
