...
&            kt, st%psnc%zt, dummyzerodiffd, st%pl%na, std%pl%na, st%pl%&
...
&            kt, st%pl%zt, std%pl%zt, st%sr, std%sr, .false., nbdirs)
!srv 23.07.21
...
&          , wrk0, wrk0d, nbdirs)
  ...
  END DO
  CALL B2TREQ_DV(ncv, switch, switchd, geo%cvvol, dummyzerodiffd0, st%pl&
