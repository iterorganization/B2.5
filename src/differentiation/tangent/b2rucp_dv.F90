...
!  1. purpose
!
!     B2RUCP reads from an un*formatted file the parameters in the
!     physics common blocks.
!
!
!  3. description (see also routine b2cdca)
!
!     This routine reads from unit (nget) the parameters in the
...
&       'faulty parameter cbnrmx')
  ...
  DO ireg=0,cbnrso+cbnrno+cbnrwe+cbnrea-1
    ...
    arg1 = 8*ns
    CALL CFRURE(nget, arg1, cbsmo(0, 0, ireg), 'cbsmo')
    arg1 = 8*ns
    CALL CFRURE(nget, arg1, cbshi(0, 0, ireg), 'cbshi')
    CALL CFRURE(nget, 8, cbshe(0, ireg), 'cbshe')
    CALL CFRURE(nget, 8, cbsch(0, ireg), 'cbsch')
    arg1 = 8*ns
    CALL CFRURE(nget, arg1, cbrec(0, 0, ireg), 'cbrec')
    CALL CFRURE(nget, 8, cbmsa(0, ireg), 'cbmsa')
    arg1 = 8*ns
    CALL CFRURE(nget, arg1, cbmsb(0, 0, ireg), 'cbmsb')
  END DO
!   ..read /b2cmpt/
  arg1 = 8*ns
  CALL CFRURE(nget, arg1, cfdf0, 'cfdf0')
  arg1 = 8*ns
  CALL CFRURE(nget, arg1, cfdna, 'cfdna')
  arg1 = 8*ns
  CALL CFRURE(nget, arg1, cfdpa, 'cfdpa')
  arg1 = 8*ns
  CALL CFRURE(nget, arg1, cfvla, 'cfvla')
  arg1 = 8*ns
  CALL CFRURE(nget, arg1, cfvsa, 'cfvsa')
  arg1 = 8*ns
  CALL CFRURE(nget, arg1, cfhci, 'cfhci')
  CALL CFRURE(nget, 8, cfhce, 'cfhce')
  CALL CFRURE(nget, 8, cfsig, 'cfsig')
  CALL CFRURE(nget, 8, cfalf, 'cfalf')
  CALL CFRURE(nget, 8, cflim, 'cflim')
