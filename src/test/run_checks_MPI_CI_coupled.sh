...
$MYPATH/b2diff.py --tolerance 0.01 --maxerr 'te ti na ni ne po' --specific-tolerance 'fhe* 0.05 rqahe 0.05 rqrad 0.05 ti 0.02 ne2 0.02 hce0 0.05 hci0 0.05 kinrgy 0.05' -i 'time|data|b2stb*|res*|del*|sm*|na*|ne0|nep|ni0|ua*|rcx*|rsa*|cdpa|csigin|dpa*|fllimvisc|b2sihs_visa|b2sihs_divu*' -v compare_results.log
