...
$MYPATH/b2diff.py --tolerance 0.15 --maxerr 'te ti na ni ne po' -i 'time|data|na|ni0|ua|ua0|fne*|fch_p|del*|res*|rrahi|rsahi|b2stbr_*|b2stbc_*|b2sihs_visa|b2sihs_divua|b2npmo_*|rcx*|smfr|smq|sch|csig*|calf|dpa*|cdpa|cvsa*|fllim*|floe_noc|floi_noc|ne2' -v compare_results.log
