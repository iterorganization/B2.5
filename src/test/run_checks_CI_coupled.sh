...
$MYPATH/b2diff.py --tolerance 1e-6 --maxerr 'te ti na ni ne po' --specific-tolerance 'ua 1e-11 ne 1e-11 ni 1e-11 na 1e-8 te 1e-11 ti 1e-11 po 1e-11' -i 'time|data|na|ni0|nep|ne0|ua|ua0|kinrgy|fne*|fmo|fhi_eir|fch_p|del*|res*|rrahi|rsamo|rsahi|b2stbr_*|b2stbc_*|b2sihs_visa|b2sihs_divua|b2sihs_divue|b2sihs_fraa|b2npmo_*|rcx*|rsana|smfr|smq|sch|she|shi|csig*|calf|alf0|hce0|hci0|chci|sig0|dpa*|cdpa|cvsa*|fllim*|floe_noc|floi_noc|ne2' -v compare_results.log
