...
$MYPATH/b2diff.py --tolerance 0.125 --maxerr 'te ti na ni ne po' -i 'time|na|ua0|fne*|del*|res*|rrahi|rsahi|b2stbr_*|b2stbc_*|b2npmo_*|rcx*|smfr|csigin|dpa*|cdpa|fllim*' -v compare_results.log
