...
$MYPATH/b2diff.py --tolerance 0.15 --maxerr 'te ti na ni ne po' -i 'time|na|ni0|ua0|fne*|del*|res*|rrahi|rsahi|b2stbr_*|b2stbc_*|b2npmo_*|rcx*|smfr|csigin|dpa*|cdpa|fllim*|floe_noc|floi_noc|ne2' -v compare_results.log
