...
$MYPATH/b2diff.py --tolerance 1e-6 --maxerr 'te ti na ni ne po' --specific-tolerance 'ua 1e-11 ne 1e-11 ni 1e-11 te 1e-11 ti 1e-11 po 1e-8 cvsa 2.5e-6 cvsa_cl 2.5e-6' -i 'time|data|del*|res*|b2stbc_smo|b2stbc_sna|b2stbc_she|b2stbc_shi|fllim0fna' -v compare_results.log
