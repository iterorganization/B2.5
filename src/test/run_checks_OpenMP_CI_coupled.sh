...
$MYPATH/b2diff.py --tolerance 0.01 --maxerr 'te ti na ni ne po' --specific-tolerance 'fhe 0.05 fhe_eir 0.02 fhep 0.02 fhe0 0.02 fhe_mdf 0.02 fhi_eir 0.02 fhet 0.05 fht 0.02 fhj 0.1 fni 0.1 fne 0.1 fne_eir 0.15 rqahe 0.05 rqrad 0.05 te 0.1 ti 0.1 po 0.1 pop 0.1 ne2 0.02 chci 0.05 hce0 0.12 hci0 0.12 fna_52 0.05 fne_32 0.05 fne_52 0.025 fni_32 0.1 fni_52 0.1 fch 0.1 fch_32 0.02 fch_52 0.02 fch_p 0.25' -i 'time|data|b2stb*|res*|del*|sm*|po0|na*|ne0|nep|ni0|ua*|kinrgy|fch0|fchp|rcx*|rra*|rsa*|alf*|calf_an|cdpa|csig*|dpa*|fllim*|b2sihs_*|b2npmo_sm*' -v compare_results.log
