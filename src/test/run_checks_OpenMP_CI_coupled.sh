...
$MYPATH/b2diff.py --tolerance 0.01 --maxerr 'te ti na ni ne po' --specific-tolerance 'fhe 0.25 fhe_eir 0.1 fhep 0.10 fhe0 0.05 fhe_mdf 0.25 fhi 0.05 fhi0 0.10 fhi_eir 0.05 fhet 0.25 fhit 0.10 fhi_mdf 0.05 fhip 0.10 fht 0.10 fhm 0.25 fna0 0.10 fne_eir 0.1 te 0.1 ti 0.1 ti0 0.1 tip 0.1 po 0.25 pop 0.25 ne2 0.02 calf 0.10 chce 0.25 hce0 0.125 chvemx 0.02 chci 0.10 hci0 0.25 fne_32 0.1 fne_52 0.1 fch_32 0.02 fch_52 0.025' -i 'time|data|b2stb*|res*|del*|sm*|po0|na*|ne0|nep|ni0|ua*|kinrgy|fna_he|fna_52|fch|fch0|fchp|fch_p|fhj|fhp|fmo|fne|fni*|rcx*|rqahe|rqrad|rra*|rsa*|alf*|calf_an|cdpa|csig*|dpa*|fllim*|b2sihs_*|b2npmo_sm*' -v compare_results.log
