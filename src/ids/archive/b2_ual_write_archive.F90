...
!>      Dejan Penko
!!
!>      @page b2uw b2_ual_write_archive
...
!!              b2mod scripts.
!!
!!      b2_ual_write_archive.f90 code is used to generate
!!      b2_ual_write_archive.exe (main
...
!!
!!      \b References:
!!          - @ref b2uw_prog "b2_ual_write_archive file reference"
...
!!-----------------------------------------------------------------------------
!>      @section b2uw_prog Program b2_ual_write_archive
!!      References:
!!          - @ref b2uw "b2_ual_write_archive main page"
!!
...
contains
    ...
    subroutine read_b2fgmtry()
        ...
        call prgini( 'b2_ual_write_archive' )
        ...
        !!...output files
        call cfopen( nout(0), 'b2_ual_write_archive.prt', 'new', 'formatted' )
    ...
    subroutine write_ids_edge_profiles( treename, shot, run, idx, username, &
        ...
        grid_description = "This IDS was written by b2_ual_write_archive"
...
end program b2_ual_write_archive
