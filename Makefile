...
${OBJDIR}/eirmod_json.o:
	@ln -sf ${EIRDIR}/eirmod_json.o ${OBJDIR}
...
ifdef USE_EIRENE
	...
	l="$$l `(cd ${SRCEIR}/modules > /dev/null; echo *.[Ff])`"; \
	l="$$l `(cd ${SRCEIR}/interfaces/couple_SOLPS_WG > /dev/null; echo eirmod_*.F90 eirmod_*.[Ff])`"; \
