...
$(OBJDIR)/$(PROG): $(addprefix $(OBJDIR)/,$(MODULES)) $(addprefix $(OBJDIR)/,$(OBJECTS))
	ar vr $(OBJDIR)/$(PROG) $(OBJDIR)/*.o

clean:
	rm -f $(OBJDIR)/*.o $(OBJDIR)/*.mod $(OBJDIR)/*.a

partclean:
	rm -f *.a b2plot_.o b2pnwl.o b2ptrgl.o get_from_movie_cdf.o ngread.o b2mds.o process.o b2mwti.o b2mod_diag.o b2mod_diag.mod b2wdat.o b2stbr.o\
	eirene_mc.o b2blnc.o b2blne.o b2blnm.o b2trace.o b2usrtrc.o b2wrint.o b2wrsep.o cdfmovie.o b2mod_neutrals_namelist.o b2mod_neutrals_namelist.mod
